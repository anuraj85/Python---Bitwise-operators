...
def new():
    ...
    fram=Frame(ez,background="pink",relief=RIDGE)
...
frame=Frame(main,bg="brown",borderwidth=2,relief=GROOVE)
...
Button(frame, text="RESULT",command=work,relief=RAISED,font=myfont).place(x=270,y=370)
Button(frame, text="EXPLANATION",relief=RAISED,command=new,font=myfont).place(x=390,y=370)
